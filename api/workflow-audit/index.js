...
const centralProxy = createCentralProxy("/workflow-audit");

/** SWA proxy: forwards /api/workflow-audit → Auricrux Central with auth enforcement. */
module.exports = function workflowAuditHandler(context, req) {
