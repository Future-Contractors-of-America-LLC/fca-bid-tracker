...
const centralProxy = createCentralProxy("/proposals");

/** SWA proxy: forwards /api/proposals → Auricrux Central /proposals with auth enforcement. */
module.exports = function proposalsHandler(context, req) {
