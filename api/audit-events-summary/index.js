...
const centralProxy = createCentralProxy("/audit-events/summary");

/** SWA proxy: forwards /api/audit-events/summary → Auricrux Central with auth enforcement. */
module.exports = function auditEventsSummaryHandler(context, req) {
