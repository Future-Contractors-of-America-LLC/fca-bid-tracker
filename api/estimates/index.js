...
const centralProxy = createCentralProxy("/estimates");

/** SWA proxy: forwards /api/estimates → Auricrux Central /estimates with auth enforcement. */
module.exports = function estimatesHandler(context, req) {
