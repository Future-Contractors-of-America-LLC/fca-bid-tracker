...
const centralProxy = createCentralProxy("/files");

/** SWA proxy: forwards /api/files → Auricrux Central with auth enforcement. */
module.exports = function filesHandler(context, req) {
