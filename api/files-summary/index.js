...
const centralProxy = createCentralProxy("/files/summary");

/** SWA proxy: forwards /api/files/summary → Auricrux Central with auth enforcement. */
module.exports = function filesSummaryHandler(context, req) {
