...
const centralProxy = createCentralProxy("/projects");

/** SWA proxy: forwards /api/projects → Auricrux Central /projects with auth enforcement. */
module.exports = function projectsHandler(context, req) {
