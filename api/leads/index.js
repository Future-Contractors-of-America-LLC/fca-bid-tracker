...
const centralProxy = createCentralProxy("/leads");

/** SWA proxy: forwards /api/leads → Auricrux Central /leads with auth enforcement. */
module.exports = function leadsHandler(context, req) {
