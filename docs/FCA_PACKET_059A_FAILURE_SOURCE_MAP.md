...
### Source 1 — `api/customer-login.js`
...
### Source 2 — `api/projects/index.js`
...
### Source 3 — `api/projects/[projectId].js`
...
### Source 7 — `api/files.js` and `api/audit-events-summary.js`
