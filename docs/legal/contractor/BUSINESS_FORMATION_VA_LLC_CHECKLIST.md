...
- [ ] Select entity type (LLC recommended for most contractors)
...
- [ ] Register for Virginia sales tax if purchasing materials for resale
- [ ] Obtain local business license if required by locality
- [ ] Add entity to `/portal/legal` license vault

## FCA reference entity

Future Contractors of America LLC  
22310 Old Vaughan Road, Dinwiddie, VA 23841

## Academy

FCA Academy Module 2: `/academy/programs/contractor-business-formation-legal/modules/2`
