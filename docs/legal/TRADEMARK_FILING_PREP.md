...
**Filing basis:**  
- **1(a)** Use in commerce â€” if live at futurecontractorsofamerica.com (yes)  
- **1(b)** Intent to use â€” for marks not yet used (mobile app pre-store)
...
| FCA (letters) | Moderate | Short acronym â€” may need acquired distinctiveness if examiner cites descriptive refs |
...
After federal registration, replace â€” with â€” for registered marks only.
