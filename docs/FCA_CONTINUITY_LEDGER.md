...
| M Auricrux load | **PASS** | central/ecosystem `FCA_LOCK_M_PROGRESS.md` + proof JSON |
| 2 Spine | **PASS** (central warranty-recurring) | central LOCK2 |
| 3–5 | **PASS** (CTE 831/831) | ecosystem LOCK3–5 |
...
1. Founder registrar CNAME for production apex / ecosystem hostname when ready
