# Backend & Admin Access â€” FCA SaaS + LMS
...
| Link | URL | Purpose |
|------|-----|---------|
| Sign in (header) | https://futurecontractorsofamerica.com/login | Standard customer login â€” no autofill |
| Admin workspace (header) | https://futurecontractorsofamerica.com/login?next=/portal/admin | Login then land on admin controls |
| Admin controls (after auth) | https://futurecontractorsofamerica.com/portal/admin | Direct route â€” auth guard redirects to login with `next=` |
...
### 1. Michael â€” founder (production account)
...
| Azure Portal | https://portal.azure.com â€” search **auricrux-central** |
