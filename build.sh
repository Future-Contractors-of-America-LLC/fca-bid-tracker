...
.nav-desktop{display:flex;align-items:center;gap:6px;flex-wrap:wrap}.nav-link{padding:8px 11px;border-radius:10px;font-size:14px;font-weight:800;color:#1e293b}.nav-link:hover,.nav-link.active{background:#edf4ff;color:#0b3ea8}
...
.btn{display:inline-flex;align-items:center;justify-content:center;padding:10px 14px;border-radius:10px;border:1px solid #cbd5e1;font-size:14px;font-weight:800}.btn-primary{background:linear-gradient(135deg,var(--blue) 0%,var(--blue2) 100%);border-color:var(--blue);color:#fff}.btn-secondary{background:#fff;color:#1d4ed8}.btn-gold{background:linear-gradient(135deg,var(--gold2) 0%,var(--gold) 100%);border-color:var(--gold2);color:#fff}
...
.page{padding:52px 0 24px}.hero-grid{display:grid;grid-template-columns:1.08fr .92fr;gap:18px}.card{background:#fff;border:1px solid var(--line);border-radius:18px;padding:22px;box-shadow:0 18px 34px rgba(15,23,42,.06)}.card-pop{background:linear-gradient(155deg,#0f3ea8 0%,#1d4ed8 48%,#3b82f6 100%);color:#f8fafc;border:0}
.eyebrow{display:inline-block;padding:7px 11px;border-radius:999px;font-size:11px;font-weight:900;letter-spacing:.08em;text-transform:uppercase;background:#eef4ff;border:1px solid #c5d8ff;color:#1d4ed8}.eyebrow-gold{background:#fff7e1;border-color:#ecd089;color:#8a6116}
