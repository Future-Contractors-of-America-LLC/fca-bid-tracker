...
const checks = [
  ...
  { path: "src/academyApiViewModels.js", includes: ["buildApiBackedTranscript", "buildApiBackedCredentialLedger", "buildApiBackedCohorts"] },
  { path: "src/hooks/useAcademyLms.js", includes: ["withdrawEnrollment", "mutateAcademyLms(\"withdraw-enrollment\""] },
