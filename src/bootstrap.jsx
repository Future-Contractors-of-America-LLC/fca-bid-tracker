  ...
  root.innerHTML = `
    <div style="min-height:100vh;display:flex;align-items:center;justify-content:center;padding:24px;background:#f8fafc;color:#0f172a;font-family:Arial,sans-serif;">
      <div style="width:min(760px,100%);background:#fff;border:1px solid #dbe3ef;border-radius:20px;box-shadow:0 20px 50px rgba(15,23,42,.08);padding:24px;">
        ...
        <h1 style="margin:12px 0;font-size:28px;line-height:1.2;">FCA could not finish loading this page.</h1>
        <p style="margin:0;color:#475569;line-height:1.6;">Return home or sign in to your workspace.${standalone ? " If you use the installed app, close it fully and reopen after updates finish." : ""}</p>
        ...
        <div style="display:flex;gap:10px;flex-wrap:wrap;margin-top:18px;">
          ...
          <a href="/portal/platform" style="text-decoration:none;background:#eff6ff;color:#1d4ed8;border:1px solid #bfdbfe;border-radius:12px;padding:10px 14px;font-weight:700;">Open workspace</a>
