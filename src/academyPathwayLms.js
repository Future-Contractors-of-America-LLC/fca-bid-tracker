...
export const PATHWAY_LMS_CONFIG = {
  ...
  cte: {
    key: "cte",
    heroTitle: "Virginia CTE Pathway",
    heroSubtitle: "Architecture & Construction Career Cluster with VDOE-aligned topics and approximately 33 course pathways across the FCA CTE catalog.",
    accent: "#0f766e",
    accentSoft: "#f0fdfa",
    border: "#99f6e4",
    icon: "cte",
    operatedBy: "Auricrux",
    dashboardRoute: "/academy/dashboard#cte",
    catalogRoute: "/academy/catalog?pathway=cte",
    features: ["VDOE-aligned pathways", "Architecture & Construction cluster", "Student-safe progression", "Credential evidence tracking"],
  },
  licensure: {
    key: "licensure",
