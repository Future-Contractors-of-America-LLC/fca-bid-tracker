  ...
  return (
    <div style={{ padding: 40, fontFamily: "Arial", background: "#f8fafc", minHeight: "100vh" }}>
      <div style={{ display: "flex", justifyContent: "space-between", gap: 16, flexWrap: "wrap", alignItems: "center" }}>
        <div>
          <p style={{ color: "#2563eb", fontWeight: 700, marginBottom: 6 }}>Customer Portal Demo</p>
          <h1 style={{ marginTop: 0, marginBottom: 8 }}>Tyler Construction Workspace</h1>
          <p style={{ marginTop: 0, color: "#4b5563" }}>Active pilot with Auricrux-guided next actions, communication visibility, and training continuity.</p>
        </div>
        <div>
          <a href="/login" style={{ marginRight: 12 }}>Switch account</a>
