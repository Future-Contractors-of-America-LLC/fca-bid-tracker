...
export default function PortalProfile() {
  ...
  return (
    <PortalShell
      ...
      subtitle="Identity, branding, product entitlements, communications, and security G현 this profile is how FCA behaves for your company."
    ...
    >
      ...
      <div style={{ ...cardStyle, marginBottom: 16, borderLeft: "4px solid #1d4ed8", background: "linear-gradient(135deg, #eff6ff 0%, #ffffff 100%)" }}>
        ...
        <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
          ...
          <button
            type="button"
            onClick={() => openAuricruxAssistant("Explain how my account acts G현 branding, entitlements, communications G현 then teach me how to customize and automate it.")}
      ...
      <div style={{ marginTop: 16 }}>
        ...
        <div style={{ ...cardStyle, marginBottom: 16, background: "linear-gradient(135deg, #f8fbff 0%, #ffffff 100%)" }}>
          ...
          <div style={{ color: "#475569", lineHeight: 1.8 }}>
            Choose which products and channels are on for your team G현 workspace, Academy, Auricrux guidance, and messages. Changes apply to your signed-in session immediately.
          </div>
        </div>
