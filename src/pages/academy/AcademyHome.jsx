...
const classrooms = [
  { id: "foundations", title: "Contractor Command Foundations", credential: "FCA Academy · Launch Classroom 01", audience: "Owners, estimators, coordinators, project managers, and customer-success staff", outcome: "Teach teams to move from intake through qualification, estimate setup, file continuity, customer tasks, and Auricrux-guided next actions.", lessons: [
  ...
  { id: "qualification", title: "Opportunity Qualification and Estimate Launch", credential: "FCA Academy · Launch Classroom 02", audience: "Sales leads, estimators, preconstruction coordinators, and customer-success operators", outcome: "Train teams to qualify opportunities, confirm evidence, route work into estimates, and preserve branded customer continuity.", lessons: [
  ...
  { id: "estimate-studio", title: "Estimate Studio and Proposal Packaging", credential: "FCA Academy · Launch Classroom 03", audience: "Estimators, coordinators, account managers, and owners", outcome: "Train teams to shape branded estimates, add scope notes, create line-item continuity, and package proposals with Auricrux support.", lessons: [
  ...
  { id: "file-intake", title: "File Intake and Evidence Continuity", credential: "FCA Academy · Launch Classroom 04", audience: "Project coordinators, document controllers, estimators, and customer-success operators", outcome: "Train teams to register files, classify evidence, generate Auricrux briefings, and keep document continuity attached to real customer work.", lessons: [
  ...
  { id: "project-command", title: "Project Command and Customer Milestone Control", credential: "FCA Academy · Launch Classroom 05", audience: "Owners, project managers, coordinators, superintendents, and customer-success staff", outcome: "Train teams to move projects through branded milestones, stage progression, permit recovery, and customer communication with Auricrux embedded in the command flow.", lessons: [
  ...
  { id: "communications-command", title: "Customer Communications Command", credential: "FCA Academy · Launch Classroom 06", audience: "Customer-success teams, owners, project coordinators, estimators, and account managers", outcome: "Train teams to send branded customer communications, preserve cross-channel continuity, and let Auricrux guide the next message or escalation path.", lessons: [
  ...
  { id: "support-command", title: "Support and Service Request Command", credential: "FCA Academy · Launch Classroom 07", audience: "Customer-success teams, owners, project coordinators, support operators, and account managers", outcome: "Train teams to create branded support requests, preserve escalation continuity, and let Auricrux guide recovery, retention, and service follow-through.", lessons: [
      { id: "support-command-identify", title: "Lesson 1 · Identify the support issue", objective: "Understand how to classify a customer problem, blocker, or service request before escalation begins.", activity: "Review one live customer issue and define the exact support request title and urgency." },
      { id: "support-command-detail", title: "Lesson 2 · Write the service request", objective: "Create a customer-ready request record that preserves the right context for recovery.", activity: "Draft the issue detail in Support Command and confirm it explains the customer impact clearly." },
      { id: "support-command-escalate", title: "Lesson 3 · Escalate with continuity", objective: "Keep support, project, billing, and communications continuity attached to the same request path.", activity: "Create one request and identify which workspace lane must follow next." },
      { id: "support-command-recovery", title: "Lesson 4 · Recover trust and retention", objective: "Use the support route to protect customer trust, warranty posture, and recurring-work potential.", activity: "Explain how the support request protects revenue, retention, or referral continuity." },
      { id: "support-command-auricrux", title: "Lesson 5 · Auricrux support operations", objective: "Use Auricrux to explain issue posture, recommend the next recovery action, and execute support-request creation.", activity: "Record one explain action, one recommend action, and one execute action Auricrux should provide in Support Command." },
    ] },
];
...
export default function AcademyHome() {
  ...
  const classroomSummaries = useMemo(() => classrooms.map((classroom) => {
    ...
    return { ...classroom, completedCount, completionPercent: Math.round((completedCount / classroom.lessons.length) * 100) };
  }), [progress]);
