  ...
  return (
    <div style={{ padding: 40, fontFamily: "Arial", background: "#f8fafc", minHeight: "100vh" }}>
      <div style={{ display: "flex", justifyContent: "space-between", gap: 16, flexWrap: "wrap", alignItems: "center" }}>
        <div>
          <p style={{ color: "#2563eb", fontWeight: 700, marginBottom: 6 }}>FCA Academy Demo</p>
          <h1 style={{ marginTop: 0, marginBottom: 8 }}>Training, Certification, and Workforce Readiness</h1>
          <p style={{ marginTop: 0, color: "#4b5563" }}>Academy shell connected to the same customer journey shown in the portal.</p>
        </div>
        <div>
          <a href="/portal" style={{ marginRight: 12 }}>Return to Portal</a>
