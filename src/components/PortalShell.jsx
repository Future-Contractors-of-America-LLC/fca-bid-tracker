    ...
    <div style={shellStyle}>
      <div style={pageStyle}>
            ...
            {portalModules.map((module) => {
              ...
              return (
                ...
                >
                  ...
                  <div style={{ fontSize: 13, lineHeight: 1.55, color: isActive ? "#1d4ed8" : "#64748b", marginTop: 6 }}>
                    {module.description}
                  </div>
                </a>
              );
            })}
            {addedPortalModules.map((module) => {
              const isActive = module.href === activeHref;
              return (
                <a
                  key={module.href}
        ...
        <div style={{ marginBottom: 20 }}>
          <AuricruxPresenceLayer surfaceKey={auricruxSurfaceKey} />
        </div>
