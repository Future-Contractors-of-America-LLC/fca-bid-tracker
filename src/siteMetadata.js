...
export const routeMetadata = {
  ...
  "/portal/audit": {
    title: "Audit | Future Contractors of America",
    description:
      "Review audit events, execution traceability, governance continuity, and operator-visible system history inside the FCA workspace.",
  },
  "/portal/messages": {
