export const websiteMarketReadiness = {
  buyerJourneys: [
    {
    ...
    {
      title: "Training and workforce buyer path",
      audience: "Leaders evaluating rollout, onboarding, and field readiness",
      outcome: "Demonstrate that Academy is a real delivery layer connected to project execution and customer continuity.",
      route: "/academy",
      label: "Open Academy",
      proof: [
        "Named classroom tracks",
        "Credential governance",
        "Curriculum-to-product alignment",
      ],
    },
    {
      title: "Enterprise rollout buyer path",
      audience: "Multi-team operators and executive decision-makers",
      outcome: "Connect website conversion, operations proof, Academy depth, and rollout planning into one sales narrative.",
      route: "/contact",
      label: "Open Contact & Rollout",
      proof: [
        "Rollout planning route",
        "Product-backed conversion CTA",
        "Cross-surface FCA continuity",
      ],
    },
  ],
  trustSignals: [
