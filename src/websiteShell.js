...
export const pricingTiers = [
  ...
  },
  {
    ...
    includes: [
      "Up to 10 active team seats in rollout planning",
      "Billing and support continuity surfaces",
      "Academy onboarding and safety-readiness access",
      "Expanded customer communications routing",
      "Monthly rollout and optimization review",
    ],
  },
  {
    ...
    includes: [
      ...
      "Executive and project communications orchestration",
      "Conference and lecture continuity for training and rollout",
      "Governance and tenant-readiness review",
      "Strategic implementation and expansion support",
    ],
  },
];
...
export const contactPaths = [
  {
    ...
    detail: "Walk through the live FCA workspace and see how FCA can support your team from first opportunity through bid handoff, project delivery, customer visibility, training, and communications routing.",
  ...
  },
  {
    ...
    detail: "Review Growth Platform and Enterprise Rollout packaging, communications lanes, and rollout sequencing for broader deployment.",
    cta: "mailto:hello@futurecontractorsofamerica.com?subject=FCA%20Growth%20or%20Enterprise%20Rollout",
    label: "Review Growth / Enterprise",
  },
];
