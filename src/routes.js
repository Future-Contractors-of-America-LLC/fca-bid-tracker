...
export const routes = {
  ...
  "/cte/login": lazyPage(() => import("./pages/website/CteLogin")),
  "/cte/program": lazyPage(() => import("./pages/website/CteProgram")),
  ...
  "/portal/command-tower": lazyPage(() => import("./pages/portal/PortalCommandTower")),
  "/portal/decision-queue": lazyPage(() => import("./pages/portal/PortalDecisionQueue")),
  ...
  "/portal/revenue-engine": lazyPage(() => import("./pages/portal/PortalRevenueEngine")),
  ...
  "/portal/communications": lazyPage(() => import("./pages/portal/PortalCommunications")),
  ...
  "/portal/hiring": lazyPage(() => import("./pages/portal/PortalHiring")),
  ...
  "/portal/admin/payroll": lazyPage(() => import("./pages/portal/PortalPayrollAdmin")),
  "/portal/admin/internal": lazyPage(() => import("./pages/portal/PortalInternalCompany")),
  "/portal/profile": lazyPage(() => import("./pages/portal/PortalProfile")),
  "/portal/employee/payroll": lazyPage(() => import("./pages/portal/PortalEmployeePayroll")),
  "/portal/employee/internal": lazyPage(() => import("./pages/portal/PortalEmployeeInternalProfile")),
  ...
  "/portal/punch": lazyPage(() => import("./pages/portal/PortalPunch")),
  "/portal/job-cost": lazyPage(() => import("./pages/portal/PortalJobCost")),
  ...
  "/cte": lazyPage(() => import("./pages/academy/CteStudentHub")),
};
