...
export const routes = {
  ...
  "/bids": lazyPage(() => import("./pages/website/BidsPublicRedirect")),
  "/bid": lazyPage(() => import("./pages/website/BidsPublicRedirect")),
  ...
  "/portal/proof": lazyPage(() => import("./pages/portal/PortalProof")),
