...
export default function Login() {
  return (
    <RouteExperienceShell
      ...
      lead="This login surface should act as the bridge from the public shell into the live customer workspace, not as a dead-end shell. It now provides the intended continuity direction even before full authentication logic is wired in."
